...
A seguir são definidos os fundamentos e tecnologias usadas ao decorrer do projeto. O foco está no padrão arquitetural Entity Component System (ECS) e no interpretador _tree-walking_, que são os principais pilares do projeto.
